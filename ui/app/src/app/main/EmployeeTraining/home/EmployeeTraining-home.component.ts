...
@Component({
  selector: 'EmployeeTraining-home',
  templateUrl: './EmployeeTraining-home.component.html',
  styleUrls: ['./EmployeeTraining-home.component.scss']
})
export class EmployeeTrainingHomeComponent implements AfterViewInit {
