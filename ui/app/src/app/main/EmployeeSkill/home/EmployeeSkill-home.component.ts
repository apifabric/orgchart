...
@Component({
  selector: 'EmployeeSkill-home',
  templateUrl: './EmployeeSkill-home.component.html',
  styleUrls: ['./EmployeeSkill-home.component.scss']
})
export class EmployeeSkillHomeComponent implements AfterViewInit {
