...
resourcename="orgchart"  # lower case, only
resourcegroup="orgchart_rg"
...
# git clone https://github.com/apilogicserver/orgchart.git
# cd orgchart
...
az group create --name orgchart_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group orgchart_rg --sku S1 --is-linux
az container create --resource-group orgchart_rg --name orgchart --image apilogicserver/orgchart:latest --dns-name-label orgchart --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//orgchart.westus.azurecontainer.io:5656'
